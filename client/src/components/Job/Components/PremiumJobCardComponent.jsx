...
function PremiumJobCardComponent({ job }) {
  const jobId = job._id;
  ...
  return (
    <>
      <div
        className="jobcomp max-[640px]:gap-2 my-4 h-[98px] flex flex-col min-[600px]:flex-row items-center border-[1px] border-black/20 rounded-2xl font-Poppin max-w-full w-full
      ...
      >
        ...
        <div className="bg-transparent flex flex-wrap items-center justify-start gap-1 text-sm text-white h-full w-1/4">
          {!showDropdown &&
...
export default PremiumJobCardComponent;
